...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(e)
      : ((t =
          "undefined" != typeof globalThis ? globalThis : t || self).interact =
          e());
})(this, function () {
  "use strict";
  function t(t, e) {
    ...
    w = {
      ...
      element: function (t) {
        ...
        return /object|function/.test(
          "undefined" == typeof Element ? "undefined" : n(Element),
        )
  ...
  var D = {
    init: function (t) {
      ...
      (D.supportsTouch =
        "ontouchstart" in t ||
        (w.func(t.DocumentTouch) && k.document instanceof t.DocumentTouch)),
        (D.supportsPointerEvent = !1 !== n.pointerEnabled && !!k.PointerEvent),
        (D.isIOS = /iP(hone|od|ad)/.test(n.platform)),
        (D.isIOS7 =
          /iP(hone|od|ad)/.test(n.platform) && /OS 7[^\d]/.test(n.appVersion)),
        (D.isIe9 = /MSIE 9/.test(n.userAgent)),
        (D.isOperaMobile =
          "Opera" === n.appName &&
          D.supportsTouch &&
          /Presto/.test(n.userAgent)),
  ...
  function K(t, e, n) {
    var r = n && t.options[n];
    return (
      N(G((r && r.origin) || t.options.origin, t, e, [t && e])) || {
        x: 0,
        y: 0,
      }
    );
  ...
  function $(t, e) {
    ...
    if ((w.object(t) && ((e = t), (t = "")), w.func(e) && n(t)))
      (r[t] = r[t] || []), r[t].push(e);
    else if (w.array(e))
  ...
  function st(t, e, n) {
    ...
    ot(r, t.page),
      (function (t, e) {
        (e = e || {}),
          I.isOperaMobile && rt(t) ? it("screen", t, e) : it("client", t, e);
      })(r, t.client),
      (t.timeStamp = n);
  }
  function ct(t) {
            ...
            if (o.options.drop.enabled) {
              ...
              if (
                ...
                for (var s = 0, c = o.getAllElements(); s < c.length; s++) {
                  var l = c[s];
                  l !== e &&
                    n.push({ dropzone: o, element: l, rect: o.getRect(l) });
                }
            }
          }
          return n;
              ...
              if (l !== a.ownerDocument)
                if (c !== l) {
                  ...
                  (r = s),
                    void 0,
                    void 0,
                    (parseInt(y((n = a)).getComputedStyle(n).zIndex, 10) ||
                      0) >=
                      (parseInt(y(r).getComputedStyle(r).zIndex, 10) || 0) &&
                      (e = o);
              else e = o;
          } else e = o;
      }
            ...
            return (function (t, e) {
              if (w.object(e)) {
                ...
                return (
                  ...
                  w.func(e.ondropactivate) &&
                    t.on("dropactivate", e.ondropactivate),
                  w.func(e.ondropdeactivate) &&
            ...
            return (function (t, e, n, r, i, o, a) {
              ...
              if (!(a = a || t.getRect(o)))
                return (
                  ...
                  t.options.drop.checker(e, n, s, t, o, r, i)
                );
              ...
              if (d && w.number(c)) {
                s =
                  (Math.max(
                    0,
                    Math.min(a.right, d.right) - Math.max(a.left, d.left),
                  ) *
                    Math.max(
                      0,
                      Math.min(a.bottom, d.bottom) - Math.max(a.top, d.top),
                    )) /
                    (d.width * d.height) >=
                  c;
              }
              t.options.drop.checker &&
                (s = t.options.drop.checker(e, n, s, t, o, r, i));
              return s;
            })(this, t, e, n, r, i, o);
          }),
    ...
    jt = {
      ...
      getCursor: function (t) {
        ...
        if (n) o = i[r + n];
          ...
          for (
            var a = "", s = 0, c = ["top", "bottom", "left", "right"];
            s < c.length;
            s++
          ) {
            var l = c[s];
  ...
  var qt = {
    ...
    stop: function () {
      (qt.isScrolling = !1),
        qt.interaction && (qt.interaction.autoScroll = null),
        Lt.cancel(qt.i);
    },
    scroll: function () {
      ...
      if (c >= 1) {
        ...
        if (l.x || l.y) {
          ...
          w.window(o)
            ? o.scrollBy(l.x, l.y)
            : o && ((o.scrollLeft += l.x), (o.scrollTop += l.y));
          var p = Vt(o),
      ...
      if (e.interacting() && qt.check(e.interactable, e.prepared.name))
        if (e.simulation) qt.x = qt.y = 0;
          ...
          (qt.x = i ? 1 : a ? -1 : 0),
            (qt.y = o ? 1 : r ? -1 : 0),
            qt.isScrolling ||
              ((qt.margin = u.margin), (qt.speed = u.speed), qt.start(e));
        }
    },
  };
  function Bt(t, e, n) {
  ...
  function Vt(t) {
    return (
      w.window(t) && (t = window.document.body),
  ...
  var Wt = {
      ...
      listeners: {
        ...
        "interactions:destroy": function (t) {
          (t.interaction.autoScroll = null),
            qt.stop(),
            qt.interaction && (qt.interaction = null);
        },
        ...
        (e.prototype.checkAndPreventDefault = function (e) {
          return (function (t, e, n) {
            ...
            if ("never" !== r)
              if ("always" !== r) {
                if (
                  e.events.supportsPassive &&
                  /^touch(start|move)$/.test(n.type)
                ) {
        ...
        t.interactions.docEvents.push({
          ...
          listener: function (e) {
            for (var n = 0, r = t.interactions.list; n < r.length; n++) {
              ...
              if (
                i.element &&
                (i.element === e.target || M(i.element, e.target))
              )
        ...
        },
        {
          ...
          value: function (t) {
            ...
            (t.coords = V({}, t.pageCoords)),
              ...
              (t.edges = V({}, o));
            for (
              var a = r ? this.states.slice(r) : this.states,
                s = ye(t.coords, t.rect),
                c = 0;
              c < a.length;
              c++
            ) {
  ...
  var Ue = {
      ...
      install: function (t) {
        var e,
          ...
          o = {
            ...
            addDelegate: function (t, e, n, o, s) {
              ...
              h ||
                ((h = { selector: t, context: e, listeners: [] }), d.push(h));
                ...
                if (d.selector === t && d.context === e) {
                  for (var h = d.listeners, v = h.length - 1; v >= 0; v--) {
                    ...
                    if (g.func === i && Ne(g.options, u)) {
                      h.splice(v, 1),
                        h.length ||
                          (p.splice(a, 1), s(e, n, c), s(e, n, l, !0)),
                        (f = !0);
                      break;
                    }
                  }
        ...
        function c(t, e) {
          for (
            var n = Ge(e), i = new We(t), o = r[t.type], a = ht(t)[0], s = a;
            w.element(s);
    ...
    He = {
      ...
      hasPointer: function (t) {
        for (
          var e = t.pointerId, n = 0, r = t.scope.interactions.list;
          n < r.length;
          n++
        ) {
          var i = r[n];
      ...
      idle: function (t) {
        for (
          var e = t.pointerType, n = 0, r = t.scope.interactions.list;
          n < r.length;
          n++
        ) {
          var i = r[n];
  ...
  function tn(t, e) {
    var n = t.doc,
      ...
      a = r.events,
      s = a[e];
    for (var c in (r.browser.isIOS && !i.events && (i.events = { passive: !1 }),
    a.delegatedEvents))
          ...
          },
          {
            ...
            value: function (t, e, n) {
              var r,
                i = this,
                o =
                  null == (r = this._actions.map[t])
                    ? void 0
                    : r.filterEventType,
                a = function (t) {
                  return (null == o || o(t)) && ve(t, i._actions);
                };
              (w.array(e) || w.object(e)) &&
                this._onOff(rn.Off, t, e, void 0, a),
                (w.array(n) || w.object(n)) &&
                  this._onOff(rn.On, t, n, void 0, a);
            },
          },
          {
            key: "setPerAction",
            value: function (t, e) {
              ...
              for (var r in e) {
                var i = r,
                  ...
                  a = e[i];
                "listeners" === i &&
                  this.updatePerActionListeners(t, o.listeners, a),
                  w.array(a)
                    ? (o[i] = mt(a))
                    : w.plainObject(a)
                      ? ((o[i] = V(o[i] || {}, ge(a))),
          ...
          },
          {
            ...
            value: function (t, e, n) {
              return (
                !t ||
                (!!w.element(n) &&
                  (w.string(t) ? F(n, t, e) : !!w.element(t) && M(t, n)))
              );
            },
          },
          {
              ...
              for (var a in o) {
                ...
                for (var s = 0, c = o[a]; s < c.length; s++) {
                  ...
                  ve(a, this._actions)
                    ...
                    : w.string(this.target)
                      ? this._scopeEvents[
                          t === rn.On ? "addDelegate" : "removeDelegate"
                        ](this.target, this._context, a, l, r)
                      : this._scopeEvents[t === rn.On ? "add" : "remove"](
                          this.target,
                          a,
                          l,
                          r,
      ...
      r(this, t),
        ...
        (this.interactStatic = (function (t) {
          var e = function e(n, r) {
            ...
            return (
              i ||
                ((i = t.interactables.new(n, r)).events.global =
                  e.globalEvents),
              i
            );
          };
          return (
            ...
            (e.stop = function () {
              for (
                var t = 0, e = this.scope.interactions.list;
                t < e.length;
                t++
              )
                e[t].stop();
  ...
  var fn = Object.freeze({
    ...
    vn = {
      ...
      set: function (t) {
        ...
        if ((V(t.edges, o), s(n, n.xIsPrimaryAxis, i, r), !n.subModification))
          return null;
        var c = V({}, r);
        ...
        var l = n.subModification.setAll(
            e(
              e({}, t),
              {},
              { rect: c, edges: o, pageCoords: i, prevCoords: i, prevRect: c },
            ),
          ),
          u = l.delta;
        l.changed &&
          (s(n, Math.abs(u.x) > Math.abs(u.y), l.coords, l.rect),
          V(i, l.coords));
        return l.eventProps;
      },
      defaults: {
      ...
      start: function (t) {
        ...
        if (e && s) {
          ...
          if (l) {
            ...
            u < 0 && ((c.left += u), (c.right += u)),
              p < 0 && ((c.top += p), (c.bottom += p));
          }
    ...
    qn = (function (t) {
      ...
      function n(t, i, o, a, s, c) {
        ...
        if (
          ...
          "doubletap" === t &&
            ((l.dt = i.timeStamp - s.tapTime), (l.double = !0));
        return l;
      }
      return (
        o(n, [
      ...
      "hold" === a &&
        (u.targets = u.targets.filter(function (t) {
          ...
          return (
            ...
            (null == (e = n.pointers[s]) || null == (r = e.hold)
              ? void 0
              : r.duration)
          );
        })),
